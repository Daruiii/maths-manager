...
class CorrectionRequestPolicy
{
     ...
     */
    public function restore(User $user, CorrectionRequest $correctionRequest): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, CorrectionRequest $correctionRequest): bool
    {
        return false;
    }
}
