                ...
                @foreach ($classes as $classe)
                    <tr class="hover:bg-grey-lighter">
                        ...
                        <td class="py-4 px-6 border-b border-grey-light flex justify-center align-start gap-2">
                            <a href="{{ route('classe.edit', $classe->id) }}" class="text-blue-500 flex items-center justify-center">
                            ...
                            <form action="{{ route('classe.destroy', $classe->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="text-red-500" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette classe ?')">
