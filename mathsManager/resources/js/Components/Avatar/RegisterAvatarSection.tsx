  ...
  return (
    <div className="flex flex-col items-center shrink-0">
      <div className={`relative group ${!avatarFile ? 'cursor-pointer' : ''}`}>
        ...
        <div
          className={`h-20 w-20 rounded-full border-2 border-dashed border-gray-200 flex items-center justify-center overflow-hidden bg-gray-50 transition-all ${avatarFile ? 'border-none shadow-md' : 'group-hover:border-admin-color/50'}`}
        >
          {avatarFile ? (
            <img
