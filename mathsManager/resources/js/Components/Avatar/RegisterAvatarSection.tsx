...
interface RegisterAvatarSectionProps {
...
export default function RegisterAvatarSection({ 
    avatarFile, 
    onFileChange, 
    onCropClick, 
    onRemoveClick 
}: RegisterAvatarSectionProps) {
    return (
        <div className="flex flex-col items-center shrink-0">
            <div className={`relative group ${!avatarFile ? 'cursor-pointer' : ''}`}>
                ...
                <div className={`h-20 w-20 rounded-full border-2 border-dashed border-gray-200 flex items-center justify-center overflow-hidden bg-gray-50 transition-all ${avatarFile ? 'border-none shadow-md' : 'group-hover:border-admin-color/50'}`}>
                    {avatarFile ? (
                        <img 
                        ...
                        <div className="text-gray-300 text-[10px] text-center px-1 font-comfortaa flex flex-col items-center">
