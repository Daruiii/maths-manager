...
export default function EinsteinQuote({ 
  ...
  return (
    <div className="mb-12 text-center">
      <div className="inline-block px-8 py-6 rounded-2xl bg-white/40 backdrop-blur-sm border border-white/60 shadow-xl transform rotate-1 hover:rotate-0 transition-transform duration-500">
