      ...
      {({ open }) => (
        <>
          <div className="flex items-center">
            <DisclosureButton className="p-2 text-text-color hover:bg-gray-100 rounded-xl transition-colors outline-none focus:outline-none">
          ...
          >
            <DisclosurePanel className="absolute top-full left-0 right-0 bg-white shadow-xl border-t border-gray-100 overflow-hidden">
                  ...
                  {(classes ?? []).length > 0 ? (
                    classes?.map((classe) => (
                      <a
                        ...
                        className="block px-3 py-3 text-base font-comfortaa text-text-color hover:bg-primary-color rounded-xl transition-colors"
                      >
                        {classe.name}
                      </a>
                    ))
                  ) : (
                    <p className="px-3 py-2 text-sm italic text-gray-400">Aucune classe</p>
                  )}
                </div>
