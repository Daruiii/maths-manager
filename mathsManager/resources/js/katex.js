export function renderKatex() {
    const elements = document.querySelectorAll('.solution-content, .clue-content, .exercise-content, .example-content, .demonstration-content, .remarque-content, .bloc-content, .recap-title');
