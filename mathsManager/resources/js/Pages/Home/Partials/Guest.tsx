...
interface GuestProps {
  introContent?: ContentBlock;
  whoamiContent?: ContentBlock;
}
    ...
    <div className="space-y-20 animate-in fade-in slide-in-from-bottom-6 duration-700">
      ...
      >
        <div className="flex-1 space-y-8">
          <h1
            id="hero-title"
            className="text-4xl md:text-5xl lg:text-6xl font-comfortaa-bold text-admin-color leading-[1.15]"
          >
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: introContent?.content || 'Plateforme de gestion de maths...',
            }}
          />
          <nav className="pt-6 flex flex-wrap gap-5" aria-label="Guest actions">
            <a href="/login" className="btn btn-primary !px-10 !py-4 text-lg">
              C'est parti !
            </a>
            <a
      ...
      <section className="flex flex-col md:flex-row gap-12 items-start">
        ...
        <aside className="md:w-1/3 bg-white rounded-3xl p-10 shadow-sm border border-gray-100 flex flex-col items-center text-center space-y-6">
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: whoamiContent?.content || 'Professeur passionné...',
            }}
          />
        </aside>
