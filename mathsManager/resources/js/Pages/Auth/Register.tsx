        ...
        <GuestLayout>
            ...
            <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 px-6 py-8 sm:px-10 sm:py-10 w-full max-w-lg">
                <div className="mb-8 text-center sm:text-left">
                    ...
                    <p className="text-text-gray text-xs font-comfortaa mt-1">Rejoignez-nous pour progresser.</p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-6" encType="multipart/form-data">
                    <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1 pt-1">
                            ...
                            <TextInput
                                ...
                                required
                            />
                            {errors.name && <p className="mt-1 text-xs text-error-color font-comfortaa">{errors.name}</p>}
                            {errors.avatar && <p className="mt-1 text-[10px] text-error-color font-comfortaa">{errors.avatar}</p>}
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <TextInput
                                ...
                                required
                            />
                            {errors.email && <p className="mt-1 text-xs text-error-color font-comfortaa">{errors.email}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                required
                            />
                            {errors.password && <p className="mt-1 text-xs text-error-color font-comfortaa">{errors.password}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                required
                            />
                            {errors.password_confirmation && <p className="mt-1 text-xs text-error-color font-comfortaa">{errors.password_confirmation}</p>}
                        </div>
                    </div>
                    ...
                    <div className="mt-4 text-center">
                        ...
                        >
                            Déjà un compte ? <span className="font-comfortaa-bold underline decoration-admin-color/30 underline-offset-4">Se connecter</span>
                        </Link>
                    </div>
                </form>
            </div>
